...
export class PeriodicService {
  ...
  public getPeriodicByName(
    name: string
  ): Observable<PeriodicElement | undefined> {
    return of(this.ELEMENT_DATA.find(x => x.name === name)).pipe(delay(100));
  }
  

  public getList(): Observable<Array<PeriodicElement>> {
